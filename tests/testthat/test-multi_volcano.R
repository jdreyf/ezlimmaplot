...
test_that("non vdiffr",{
  ...
  expect_equal(ggplot2::ggplot_build(mvl$First3)$data[[3]]$colour[[1]], "green")
  expect_equal(ggplot2::ggplot_build(mvl$First3)$data[[3]]$y[1], -log10(mvl$First3$data["gene1", "First3.p"]))
  expect_equal(ggplot2::ggplot_build(mvl$Last3)$data[[3]]$colour[[1]], "black")
  expect_equal(ggplot2::ggplot_build(mvl$Last3)$data[[3]]$y[1], -log10(mvl$Last3$data["gene1", "Last3.p"]))
  expect_equal(ggplot2::ggplot_build(mvl$Last3vsFirst3)$data[[3]]$colour[[1]], "green")
  expect_equal(ggplot2::ggplot_build(mvl$Last3vsFirst3)$data[[3]]$y[1],
  ...
  expect_equal(ggplot2::ggplot_build( mvl2$First)$data[[3]]$colour, "green")
  expect_equal(ggplot2::ggplot_build( mvl2$First)$data[[3]]$y[1], -log10(mvl2$First3$data["gene1","First3.FDR"]))
  expect_equal(ggplot2::ggplot_build( mvl2$Last3)$data[[3]]$colour[1], "black")
  expect_equal(ggplot2::ggplot_build( mvl2$Last3)$data[[3]]$y[1], -log10(mvl2$Last3$data["gene1","Last3.FDR"]))
  expect_equal(ggplot2::ggplot_build( mvl2$Last3vsFirst3)$data[[3]]$colour, "green")
  expect_equal(ggplot2::ggplot_build(mvl2$Last3vsFirst3)$data[[3]]$y[1],
  ...
  expect_equal(ggplot2::ggplot_build(mvlc3$First)$data[[3]]$y, -log10(mvlc3$First$data["gene1","First3.p"]))
  expect_equal(mvlc3$Last3$data["gene25","Last3.avg"], res.df["gene25","Last3.avg"])
  expect_equal(ggplot2::ggplot_build(mvlc3$Last3)$data[[3]]$y[1], -log10(mvlc3$Last3$data["gene1","Last3.p"]))
  expect_equal(mvlc3$Last3vsFirst3$data["gene25","Last3vsFirst3.avg"], res.df["gene25","Last3vsFirst3.avg"])
  expect_equal(ggplot2::ggplot_build(mvlc3$Last3vsFirst3)$data[[3]]$y[1],
  ...
  expect_equal(ggplot2::ggplot_build(mvlc3$First)$data[[3]]$colour, "black")
  expect_equal(ggplot2::ggplot_build(mvlc3$Last3)$data[[3]]$colour[1], "black")
  expect_equal(ggplot2::ggplot_build(mvlc3$Last3vsFirst3)$data[[3]]$colour, "black")
  ...
  expect_equal(ggplot_build(mvlc7$Last3)$data[[8]]$linetype, "dashed")

  expect_equal(ggplot2::ggplot_build(mvlc7$Last3vsFirst3)$data[[8]]$yintercept[1], -log10(0.05))
  expect_equal(ggplot2::ggplot_build(mvlc7$Last3vsFirst3)$data[[6]]$y[1],
                        -log10(mvlc7$Last3vsFirst3$data["gene1", "Last3vsFirst3.p"]))
  expect_equal(ggplot_build(mvlc7$Last3vsFirst3)$data[[8]]$linetype, "dashed")
  ...
  expect_equal(ggplot_build(mvlc8$First3)$data[[6]]$linetype[1], "dashed")
  expect_equal(ggplot_build(mvlc8$First3)$data[[6]]$linetype[2], "dotted")
  expect_equal(ggplot2::ggplot_build(mvlc8$First3)$data[[6]]$yintercept[1], -log10(0.05))
  expect_equal(ggplot2::ggplot_build(mvlc8$First3)$data[[6]]$yintercept[2], -log10(0.001))

  expect_equal(ggplot_build(mvlc8$Last3)$data[[8]]$linetype[1], "dashed")
  expect_equal(ggplot_build(mvlc8$Last3)$data[[8]]$linetype[2], "dotted")
  expect_equal(ggplot2::ggplot_build(mvlc8$Last3)$data[[8]]$yintercept[1], -log10(0.05))
  expect_equal(ggplot2::ggplot_build(mvlc8$Last3)$data[[8]]$yintercept[2], -log10(0.001))

  expect_equal(ggplot_build(mvlc8$Last3vsFirst3)$data[[8]]$linetype[1], "dashed")
  expect_equal(ggplot_build(mvlc8$Last3vsFirst3)$data[[8]]$linetype[2], "dotted")
  expect_equal(ggplot2::ggplot_build(mvlc8$Last3vsFirst3)$data[[8]]$yintercept[1], -log10(0.05))
  expect_equal(ggplot2::ggplot_build(mvlc8$Last3vsFirst3)$data[[8]]$yintercept[2], -log10(0.001))
