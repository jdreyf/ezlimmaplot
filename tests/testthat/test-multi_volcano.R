...
test_that("missing logFC or p-value/FDR columns", {
 ...
 expect_error(multi_volcano(tab=res.df2, name="tmp", ntop.sig = 1, ntop.lfc = 1, cut.lfc=1, type.sig="FDR", same.scale = TRUE,
                            cut.sig=0.01, up.cut.color = "green", down.cut.color="green", ann.rnames=c("gene1", "gene25"), lab.col='Gene.Symbol'), plot=FALSE)
...
test_that("non vdiffr",{
  ...
  expect_error(multi_volcano(tab=res.df, lab.col=NULL, name=NA, ntop.sig = 1, ntop.lfc = 1, cut.lfc=1,
                     cut.sig=0.01, up.cut.color = "green", down.cut.color="green", ann.rnames=c("gene1", "gene25"), plot = FALSE))
  mvl <- multi_volcano(tab=res.df, name=NA, ntop.sig = 1, ntop.lfc = 1, cut.lfc=0,
                       cut.sig=6.5*10**(-3), up.cut.color = "green", down.cut.color="green", ann.rnames=c("gene1", "gene25"), plot = FALSE)
  ...
  mvl2 <-  multi_volcano(tab=res.df, name=NA, cut.lfc=1, cut.sig=0.01, up.cut.color = "green", down.cut.color="green", up.ann.color = "green", down.ann.color = "green",
  ...
  mvlc3 <- multi_volcano(tab=res.df, name=NA, ntop.sig = 1, ntop.lfc = 1, cut.lfc=1,
                      cut.sig=0.01, up.cut.color = "black", down.cut.color = "black", up.ann.color = "red", plot = FALSE)
  #Validating the location of the specific point
  ...
  mvlc4 <- multi_volcano(tab=res.df[-1,], name=NA, ntop.sig = 1, ntop.lfc = 1, cut.lfc=1, lab.col = "Gene.Symbol",
                      cut.sig=0.01, up.cut.color = "blue", down.cut.color="blue", up.ann.color = "red", plot = FALSE)
  #Validating the location of the specific point
  ...
  mvlc5 <- multi_volcano(tab=res.df, name=NA, ntop.sig = 1, ntop.lfc = 1, plot = FALSE, cut.lfc=1,
                                     cut.sig=0.01, up.cut.color = "green", down.cut.color="green", ann.rnames=c("gene1", "gene25"))
  #Validating the colour of the point
  ...
  mvlc7 <- multi_volcano(tab=res.df, ntop.sig = 1, ntop.lfc = 1, cut.lfc=1, name=NA, plot=FALSE, lab.col = "Gene.Symbol",
                      cut.sig=0.01, up.cut.color = "green", down.cut.color="green", ann.rnames=c("gene1", "gene25"), lines.sig = 0.05)
  #Validating points
  ...
  mvlc8 <- multi_volcano(tab=res.df, ntop.sig = 1, ntop.lfc = 1, cut.lfc=1, name=NA, plot=FALSE, lab.col = "Gene.Symbol",
                      cut.sig=0.01, up.cut.color = "green", down.cut.color="green", ann.rnames=c("gene1", "gene25"), lines.sig = c(0.05, 0.001))
  ...
  mvlc10 <- multi_volcano(tab=res.df, ntop.sig = 1, ntop.lfc = 1, cut.lfc=1, name=NA, plot=FALSE, lab.col = "Gene.Symbol",
                      type.sig="FDR", cut.sig=0.01, up.cut.color = "green", down.cut.color="green", ann.rnames=c("gene1", "gene25"), lines.sig = 0.05)
...
test_that("raster", {
  mvol.norast <- multi_volcano(tab=res.df, name="tmp_norast", ntop.sig = 1, ntop.lfc = 1, cut.lfc=1, cut.sig=0.01, up.cut.color = "green", down.cut.color="green",
                               ann.rnames=c("gene1", "gene25"), lab.col='Gene.Symbol')
  mvol.rast <- multi_volcano(tab=res.df, name="tmp_rast", ntop.sig = 1, ntop.lfc = 1, cut.lfc=1, cut.sig=0.01, up.cut.color = "green", down.cut.color="green",
...
test_that("vdiffr", {
  mvol <- multi_volcano(tab=res.df, name="tmp", ntop.sig = 1, ntop.lfc = 1, cut.lfc=1, cut.sig=0.01, up.cut.color = "green", down.cut.color="green",
                        ann.rnames=c("gene1", "gene25"), lab.col='Gene.Symbol')
  ...
  mvol2 <- multi_volcano(tab=res.df, name="tmp", ntop.sig = 1, ntop.lfc = 1, cut.lfc=1, type.sig="FDR", same.scale = TRUE,
                         cut.sig=0.01, up.cut.color = "green", down.cut.color="green", ann.rnames=c("gene1", "gene25"), lab.col='Gene.Symbol')
