test_that("from helper", {
  ...
  expect_equal(pivot_roast_longer(rc2, prefix.v = "Last3", direction.v = "Down")$NSig, 0)
  expect_equal(signif(pivot_roast_longer(rc2, prefix.v = "Last3", direction.v = "Down")$FDR, 2), 0.6)
  expect_equal(pivot_roast_longer(rc2, prefix.v = "Last3vsFirst3", direction.v = "Down")$NSig[2], 2)
})
