...
test_that("non-vdiffr", {
  ...
  ezvol2 <- ezvolcano(tab=res.df, comparison = "First3", name=NA, cut.lfc=1, cut.sig=0.01, up.cut.color = "green", down.cut.color = "green",
  ...
  ezvol3 <- ezvolcano(tab=res.df, comparison = "First3", name=NA, ntop.sig = 1, ntop.lfc = 1, cut.lfc=1,
                      cut.sig=0.01, up.cut.color = "black", down.cut.color = "black", up.ann.color = "red", x.bound = 3, y.bound=30, plot = FALSE)
  #Validating the location of the specific point
  ...
  ezvol4 <- ezvolcano(tab=res.df[-1,], comparison = "First3", name=NA, ntop.sig = 1, ntop.lfc = 1, cut.lfc=1,
                      cut.sig=0.01, up.cut.color = "blue", down.cut.color = "blue", up.ann.color = "red", x.bound = 3, y.bound=30, plot = FALSE)
  #Validating the location of the specific point
  ...
  ezvol6 <- ezvolcano(tab=res.df, comparison = "First3", name=NA, ntop.sig = 1, ntop.lfc = 1, cut.lfc=1,
                      cut.sig=0.01, up.cut.color = "green", down.cut.color = "green", ann.rnames=c("gene1", "gene25"), shape = 1, plot=FALSE)
  ...
  expect_error(ezvolcano(tab=res.df, comparison = "First3", name=NA, ntop.sig = 1, ntop.lfc = 1, cut.lfc=1,
                           lab.col=NULL, cut.sig=0.01, up.cut.color = "green", down.cut.color = "green", ann.rnames=c("gene1", "gene25"), plot=FALSE))
  ...
  expect_error(ezvolcano(tab=res.df, comparison = "First3", ntop.sig = 1, ntop.lfc = 1, cut.lfc=1, name=NA, plot=FALSE,
                      cut.sig=0.01, up.cut.color = "green", down.cut.color = "green", ann.rnames=c("gene1", "gene25"), lines.sig = 10**(-1*1:6)))
...
test_that("vdiffr", {
  ...
  ezvol2 <- function() ezvolcano(tab=res.df, comparison = "First3", name=NA, cut.lfc=1, cut.sig=0.01, up.cut.color = "green", down.cut.color = "green",
                                 type.sig = "FDR")
  ...
  ezvol3 <- function() ezvolcano(tab=res.df, comparison = "First3", name=NA, ntop.sig = 1, ntop.lfc = 1, cut.lfc=1,
                                 cut.sig=0.01, up.cut.color = "black", down.cut.color = "black", up.ann.color = "red", x.bound = 3, y.bound=30)
  ...
  ezvol4 <- function() ezvolcano(tab=res.df[-1,], comparison = "First3", name=NA, ntop.sig = 1, ntop.lfc = 1, cut.lfc=1,
                                 cut.sig=0.01, up.cut.color = "blue", down.cut.color = "blue", up.ann.color = "red", x.bound = 3, y.bound=30)
  ...
  ezvol6 <- function() ezvolcano(tab=res.df, comparison = "First3", name=NA, ntop.sig = 1, ntop.lfc = 1, cut.lfc=1,
                                 cut.sig=0.01, up.cut.color = "green", down.cut.color = "green", ann.rnames=c("gene1", "gene25"), shape = 1)
